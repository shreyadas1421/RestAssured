...
#--POST Request--
	...
	#~~Negative scenarios~~		    
				  ...
				  Then User receives 400 Created Status with response body
				   ...
				   Examples: 
				          | userComments | userEduPg| userEduUg|userFirstName|userLastName|userLinkedinUrl|password|userLoginEmail|userMiddleName|userPhoneNumber|roleId|userRoleStatus|userTimeZone|userVisaStatus|
				      	  | New User Admin | BCA      | MCA      | FirstUser   | Last       |linkedin|234353 |update05@gmail.com | M         |3435457693     |R01   | Active       |EST         | H4-EAD        |
				 ...
				 @Create_user_negative
				  ...
				  Then User receives 400 Created Status with response body
				    ...
				    Examples: 
				          | userComments | userEduPg| userEduUg|userFirstName|userLastName|userLinkedinUrl|password|userLoginEmail|userMiddleName|userPhoneNumber|roleId|userRoleStatus|userTimeZone|userVisaStatus|
				          | New User Admin |   BCA    | MCA      | FirstUser   | Last       | www.linkedin.com|234353 | update06@gmail.com| M         |9887909761    |R01   | Active       |        | H4       |
...
#---PUT Request---
	...
	@update_user_updateUserLoginStatus
	 ...
	 |     Active  |       123|     R01   | Active | stest1234@gmail.com|
	
	@update_user_UpdateUserBatchProgram
	 Scenario: Check if admin is able to update UserRoleProgramBatchStatus
