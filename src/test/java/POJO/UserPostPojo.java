...
public class UserPostPojo {
	...
	private UserPost_userLoginPojo userLogin;
	private String userMiddleName;
	private String userPhoneNumber;
	private List<UserPost_userRoleMaps> userRoleMaps;
	...
	public UserPost_userLoginPojo getUserLogin() {
		return userLogin;
	}
	public void setUserLogin(UserPost_userLoginPojo userLogin) {
	...
	public List<POJO.UserPost_userRoleMaps> getUserRoleMaps() {
		return userRoleMaps;
	}
	public void setUserRoleMaps(List<POJO.UserPost_userRoleMaps> userRoleMaps) {
